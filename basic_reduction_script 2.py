...
# this is the local code that I can edit on my computer, any changes that are made can be copied back to the
# main 'mq_spectrograph' folder, which can then be pushed onto github/gitkraken
# from here then you can create a branch and then push/pull files to and from the repository
...
##### the above lines of code work for the setup that you have #####
